...
local function drawSnake()
    ...
    for i, segment in ipairs(state.snake) do
        ...
        if state.rainbowMode then
            ...
            if i == 1 then
                local yellowR, yellowG, yellowB = 1.0, 1.0, 0.2
                ...
                local yellowR, yellowG, yellowB = 0.9 * gradient, 0.9 * gradient, 0.1 * gradient
            ...
            if i == 1 then
                ...
                local gradient = math.max(0.4, 1 - (i * 0.05))
                r, g, b = 0.9 * gradient, 0.9 * gradient, 0.1 * gradient
            end
        end
